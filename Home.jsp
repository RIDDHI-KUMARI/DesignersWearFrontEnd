					...
					<div class="brands_products">
						...
						<div class="brands-name">
							<ul class="nav nav-pills nav-stacked">
								<li><a href="#"> <span class="pull-right">(50)</span>Olay
								</a></li>
								<li><a href="#"> <span class="pull-right">(56)</span>Peter
										England2p
								</a></li>
								<li><a href="#"> <span class="pull-right">(27)</span>Denim
								</a></li>
								<li><a href="#"> <span class="pull-right">(32)</span>Wrangler
								</a></li>
								<li><a href="#"> <span class="pull-right">(5)</span>Levis
								</a></li>
							</ul>
						</div>
					</div>
